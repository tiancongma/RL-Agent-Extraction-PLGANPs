...
class EvidenceBindingRiskAssessmentTests(unittest.TestCase):
    ...
    def test_run_risk_assessment_writes_field_formulation_paper_outputs(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            pack_path = root / "packs.jsonl"
            packs = [
                {"paper_key": "P1", "final_formulation_id": "P1__F1", "field_name": "a", "frozen_value": "x", "binding_status": "direct_supported", "assignment_path": "direct_same_table_row"},
                {"paper_key": "P1", "final_formulation_id": "P1__F1", "field_name": "b", "frozen_value": "y", "binding_status": "value_only_match", "assignment_path": "unresolved"},
            ]
