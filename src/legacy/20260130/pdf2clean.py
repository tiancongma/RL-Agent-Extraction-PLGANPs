...
-----------------------------------------------
python src/pdf2clean.py
  -> uses manifest .\\data\\cleaned\\index\\manifest.tsv
  -> writes to     .\\data\\cleaned\\tmp_pdf2clean

Or explicit:
python src/pdf2clean.py --manifest .\\data\\cleaned\\manifest.tsv --out-dir .\\data\\cleaned\\tmp_pdf2clean --prefer html --overwrite --verbose
