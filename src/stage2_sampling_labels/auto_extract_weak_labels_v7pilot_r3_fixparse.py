...
def flatten_row(
    ...
    out: Dict[str, Any] = {
        ...
        "stage2_semantic_source_mode": str(form.get("stage2_semantic_source_mode") or "legacy_noncomposite_stage2").strip() or "legacy_noncomposite_stage2",
        "semantic_universe_authority": str(form.get("semantic_universe_authority") or "").strip(),
        "row_materialization_mode": str(form.get("row_materialization_mode") or "").strip(),
        "semantic_scope_authority": str(form.get("semantic_scope_authority") or "").strip(),
        "semantic_scope_ref": str(form.get("semantic_scope_ref") or "").strip(),
        "table_id": str(form.get("table_id") or "").strip(),
        "table_row_id": str(form.get("table_row_id") or "").strip(),
        "table_row_variable_assignments_json": str(form.get("table_row_variable_assignments_json") or "").strip(),
