...
LLM_PROMPT_TEMPLATE = (
    ...
    "- emul_type:\n"
    "  Structural architecture of the emulsion system \n"
    "  (e.g., \"O/W\", \"W/O/W\", \"double emulsion\").\n"
    "  Do NOT infer a more specific architecture unless explicitly stated in the text.\n"
    "  For example, \"double emulsion\" must NOT be inferred as \"W/O/W\" unless explicitly written.\n\n"
    "- emul_method:\n"
    "  Physical energy input used to generate emulsion droplets \n"
    "  (e.g., sonication, probe sonication, homogenization, high-pressure homogenization, stirring).\n"
    "  Only extract an energy method if explicitly stated.\n"
    "  Do NOT infer sonication or homogenization from phrases such as \n"
    "  \"double emulsion solvent evaporation\".\n"
    "  Process descriptors (e.g., solvent evaporation, solvent diffusion) are NOT energy methods.\n\n"
