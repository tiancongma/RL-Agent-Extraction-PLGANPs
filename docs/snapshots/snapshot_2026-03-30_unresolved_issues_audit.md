...
Evidence used for this audit came from governed docs, governed memory, and the current repository authority pointer in [data/results/ACTIVE_RUN.json](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/ACTIVE_RUN.json). The active lineage inspected was [run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1), and no child `RUN_CONTEXT.md` files were present under that lineage root.

# 2. Resolved vs unresolved boundary

Closed or materially decided:

- The Stage2 architecture split is now explicitly frozen again: LLM for open semantic discovery, deterministic logic for downstream relation resolution, normalization, filtering, audit, and materialization. Evidence: [project/4_DECISIONS_LOG.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/project/4_DECISIONS_LOG.md#L2274), [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L31).
- Stage2.5 remains retired / archived, not active mainline. Evidence: [project/2_ARCHITECTURE.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/project/2_ARCHITECTURE.md), [project/PIPELINE_SCRIPT_MAP.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/project/PIPELINE_SCRIPT_MAP.md).
- Identity freeze is no longer just advisory; it is an enforced Stage5 gate. Evidence: [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L30).
- Identity-variable preservation itself is implemented. Evidence: [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L27).
...
|---|---|---|---|---|---|---|---|---|---|
| U1 | Frozen LLM Stage2 authority is not yet reflected in runtime authority everywhere | architecture / governance | unresolved with direct doc-memory-run conflict | [project/2_ARCHITECTURE.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/project/2_ARCHITECTURE.md#L55), [project/ACTIVE_PIPELINE_FLOW.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/project/ACTIVE_PIPELINE_FLOW.md#L219), [README.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/README.md#L115), [data/results/ACTIVE_RUN.json](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/ACTIVE_RUN.json#L2), [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L31) | The contract was frozen, but the active run and parts of the repo surface still resolve to deterministic semantic-emitter authority, and the flow doc explicitly says a compliant restored LLM Stage2 entrypoint is “not yet re-established”. | Future work can silently keep using the wrong Stage2 authority boundary. | Decide whether to restore a compliant LLM Stage2 entrypoint or temporarily demote `ACTIVE_RUN.json` from benchmark authority until that exists; then align README and memory rows. | critical | architecture blocker; benchmark blocker; scaling blocker |
...
- The architecture now says “Stage2 authority belongs to LLM semantic discovery, not deterministic semantic reconstruction” in [project/2_ARCHITECTURE.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/project/2_ARCHITECTURE.md#L55).
- The flow doc says deterministic semantic emitters “must not be treated as active Stage2 mainline authority” in [project/ACTIVE_PIPELINE_FLOW.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/project/ACTIVE_PIPELINE_FLOW.md#L48).
- The same flow doc also says the compliant restored LLM Stage2 entrypoint is “not yet re-established” and the deterministic emitter “remains available only for fallback, comparator, migration-support, or diagnostic runs” in [project/ACTIVE_PIPELINE_FLOW.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/project/ACTIVE_PIPELINE_FLOW.md#L219).
- `README.md` still says “Current active Stage 2 script” is `emit_semantic_objects_from_cleaned_papers_v1.py` in [README.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/README.md#L115).
- `ACTIVE_RUN.json` still points to the deterministic semantic-emitter lineage in [data/results/ACTIVE_RUN.json](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/ACTIVE_RUN.json#L2).
...
- The active run explicitly says the maintained compare script could not consume the repaired-v4 workbook because it lacked the `review_formulations` sheet, so a read-only custom evaluator was used instead in [RUN_CONTEXT.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1/RUN_CONTEXT.md#L46).
- The same run says its final-table outputs should be interpreted together with the active baseline comparison because row identity changed materially in [RUN_CONTEXT.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1/RUN_CONTEXT.md#L94).
...
- Memory labels the capability “IMPLEMENTED / UNDER EVALUATION” and says “evaluation misalignment is observed due to row-binding differences” in [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L27).
- The changed-papers report says `5GIF3D8W`, `BXCV5XWB`, and `WFDTQ4VX` “appear to drift ids without scientific benefit” in [changed_papers_detailed_report.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1/audit_identity_variable_diff/changed_papers_detailed_report.md#L12), [changed_papers_detailed_report.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1/audit_identity_variable_diff/changed_papers_detailed_report.md#L48), and [changed_papers_detailed_report.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1/audit_identity_variable_diff/changed_papers_detailed_report.md#L171).
...
- The binding proposal states: “The maintained `compare_final_table_to_gt_v1.py` entrypoint is a count-level comparison only. It does not perform formulation-row binding” in [binding_priority_proposal.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1/audit_binding_risk/binding_priority_proposal.md#L13).
- The same proposal names papers that “still need Layer2-style identity repair even after Priority 2” in [binding_priority_proposal.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1/audit_binding_risk/binding_priority_proposal.md#L134).
- MDEC087 says initial validation scope is only WIVUCMYG and 5ZXYABSU in [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L28).
...
- The active final-output summary says “exact core-signature fields for broader collapse remain unresolved” and “DOE-aware coordinate closure still needs a later explicit contract” in [final_output_summary_v1.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1/final_output_summary_v1.md#L80) and [final_output_summary_v1.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/results/run_20260329_1753_63b0c8d_dev15_identity_variable_preservation_exp_v1/final_output_summary_v1.md#L84).
...
- The Layer3 method says the “current repo capability is partially present but not yet unified into one formulation-centered audit system contract” in [docs/methods/layer3_field_gt_protocol_v1.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/docs/methods/layer3_field_gt_protocol_v1.md#L37).
- MDEC081 repeats the same state in [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L22).
...
- The parking lot explicitly records “Evidence Alignment Granularity (Deferred)” in [project/5_PARKING_LOT.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/project/5_PARKING_LOT.md).
- The Stage2 field audit says the LLM is already doing too much coarse evidence-binding and arbitration work in [docs/methods/stage2_llm_field_audit_and_db_redesign_2026-03-25.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/docs/methods/stage2_llm_field_audit_and_db_redesign_2026-03-25.md).
- The Layer3 protocol still needs `unresolved_table`, `missing_evidence_anchor`, and other downgrade states in [docs/methods/layer3_field_gt_protocol_v1.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/docs/methods/layer3_field_gt_protocol_v1.md#L108) and [docs/methods/layer3_field_gt_protocol_v1.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/docs/methods/layer3_field_gt_protocol_v1.md#L590).
...
- MDEC083 says “Stage5 outputs are not yet a fully normalized modeling surface” in [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L24).
- The Layer3 protocol says “concentration vs absolute amount ambiguity is unresolved” and “phase-volume denominator is unclear” in [docs/methods/layer3_field_gt_protocol_v1.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/docs/methods/layer3_field_gt_protocol_v1.md#L457) and [docs/methods/layer3_field_gt_protocol_v1.md](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/docs/methods/layer3_field_gt_protocol_v1.md#L459).
...
- MDEC083 says `drug_name` alone is insufficient and calls for a chemical-entity registry with more identifiers and properties in [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L24).
...
- MDEC083 says formulation-defining variable detection and identity integrity remain open in [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L24).
- MDEC086 says identity-bearing variables such as pH now survive to final output through `identity_variables_json` in [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L27).
- MERR593 still says pH disappears before workbook materialization in [data/mem/v1/err.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/err.tsv#L370).
...
- MDEC085 remains active and says PDI and zeta are “OPEN PROBLEM / NOT INVESTIGATED” in [data/mem/v1/dec.tsv](/c:/Users/tianc/Downloads/GitHub/RL-Agent-Extraction-PLGANPs/data/mem/v1/dec.tsv#L26).
