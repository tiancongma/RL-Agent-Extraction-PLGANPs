...
- `10.1002/jps.24101`: GT=26 formulation rows, pred=11; over-seg=no, under-seg=yes, boundary=broken, non-form suppression=no, inheritance separation=no.
- `10.1016/j.ejpb.2004.09.002`: GT=22 formulation rows, pred=8; over-seg=no, under-seg=yes, boundary=broken, non-form suppression=not_applicable, inheritance separation=yes.
...
## Engineering readout
- Predicted formulation rows: 28 vs GT 57.
