...
- `10.1038/s41598-017-00696-6`: GT=5 formulation rows, pred=5; over-seg=no, under-seg=no, boundary=mixed, non-form suppression=partial, inheritance separation=yes.
...
- `10.1080/10717544.2016.1199605`: GT=29 formulation rows, pred=29; over-seg=no, under-seg=no, boundary=mixed, non-form suppression=no, inheritance separation=no, reconciliation=30->29.
...
## Stage4 reconciliation adjustments
- `10.1080/10717544.2016.1199605`: raw count 30 -> reconciled count 29. WFDTQ4VX DoE coordinate reconciliation applied: design rows keyed by drug mg + polymer mg + surfactant percent; checkpoint rows mapped from Table 7 coded levels through Table 1 factor levels; predicted/observed values ignored for identity.

## Engineering readout
- Predicted formulation rows: 106 vs GT 150.
- Predicted candidate_non_formulation rows: 20 vs GT non-formulation rows 75.
