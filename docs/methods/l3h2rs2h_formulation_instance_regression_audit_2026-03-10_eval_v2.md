...
- `10.1016/j.ejpb.2004.09.002`: GT=22 formulation rows, pred=21; over-seg=no, under-seg=yes, boundary=mixed, non-form suppression=not_applicable, inheritance separation=yes.

## Engineering readout
- Predicted formulation rows: 21 vs GT 22.
- Predicted candidate_non_formulation rows: 0 vs GT non-formulation rows 0.
