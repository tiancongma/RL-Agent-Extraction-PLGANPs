...
- `10.1016/j.ejpb.2004.09.002`: GT=22 formulation rows, pred=20; over-seg=no, under-seg=yes, boundary=broken, non-form suppression=not_applicable, inheritance separation=yes.
...
## Engineering readout
- Predicted formulation rows: 55 vs GT 57.
