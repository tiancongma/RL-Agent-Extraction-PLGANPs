...
- `docs/audits/dev15_llm_capability_audit_v1.tsv`
- `docs/audits/dev15_llm_capability_audit_summary.md`
...
From `docs/audits/dev15_llm_capability_audit_v1.tsv`:
...
From `docs/audits/dev15_llm_capability_audit_summary.md`:
